...
class Invoice(RulesModel):
    ...
    season = models.ForeignKey("teams.Season", on_delete=models.CASCADE, verbose_name=_("season"))
...
class Material(models.Model):
    ...
    team = models.ForeignKey("teams.Team", on_delete=models.CASCADE, verbose_name=_("team"), blank=True, null=True)
    role = models.ForeignKey("teams.TeamRole", on_delete=models.CASCADE, verbose_name=_("team role"), blank=True, null=True)
